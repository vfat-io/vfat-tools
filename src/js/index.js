...
window.NETWORKS = {
  ...
  HOO: {
    ...
    blockExplorerUrls: ['https://www.hooscan.com'],
  },
  MOONRIVER: {
    chainId: '0x505',
    chainName: 'Moonriver',
  ...
  AVALANCHE: {
    ...
    blockExplorerUrls: ['https://explorer.avax.network', 'https://cchain.explorer.avax.network'],
  },
  FANTOM: {
    chainId: '0xFA',
...
const infuraId = atob(window.ETHEREUM_NODE_URL)
  .split('/')
  .pop()
