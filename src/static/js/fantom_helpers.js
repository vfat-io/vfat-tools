...
async function getFantomToken(App, tokenAddress, stakingAddress) {
    ...
    try {
      const VAULT = new ethers.Contract(tokenAddress, FANTOM_VAULT_ABI, App.provider);
