...
async function loadHelmetSynthetixPools2(App, tokens, prices, abi, address) {
    ...
    return await printHelmetSynthetixPool1(App, info);
}
...
async function printHelmetSynthetixPool1(App, info, chain="bsc") {
  ...
  const weeklyAPR1 = info.usdPerWeek1 / info.staked_tvl0 * 100;
