...
const nft_manager_address_v4 = '0x58daec3116aae6D93017bAAea7749052E8a04fA7'
...
const sickle_factory_address = '0x3575Aa02Ae85D8Cd2AaE6DCaA5D8750cFc9622e6'
const sweep_address = '0xBfc6216915536bf83e94fB8f24Fc197adB2e3401'
...
const withdraw_nfts = async function (App, nft_manager_v4, nft_manager_address_v4, sickleAddress) {
  ...
  for (const p of positions) {
    ...
    const token0Meta = await getErc20MetaCached(App, tokenMetaCache, p.poolKey.currency0, ROBINHOOD_CHAIN_ID)
    const token1Meta = await getErc20MetaCached(App, tokenMetaCache, p.poolKey.currency1, ROBINHOOD_CHAIN_ID)
