$(function() {
  consoleInit(main)
    ...
    async function main() {
      ...
      const PrismaCurvePools = [
        ...
        "0xB91CCC18cF012b2024d84a7798Af813965fbcb7D"  //check for lp_price() in minter contract
      ].map(a => {
        return {
          address: a,
      ...
      const allPools = [
        ...
        "0xbCED0F33beDD1D325f069D5481C7076A5d0709a4",
        "0x49cd193227a896F867AFDB6A5edFb53A3Ee7fb49",
        "0xB91CCC18cF012b2024d84a7798Af813965fbcb7D"
      ].map(a => {
        return {
          address: a,
          abi: PRISMA_CONVEX_STAKING_ABI,
  ...
  async function loadPrismaStablePools(App, tokens, prices, pools) {
    ...
    for (const i of infos) {
      let p = await printPrismaPool(App, i);
  ...
  async function loadPrismaCurvePoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
    rewardTokenAddress, stakeTokenFunction) {
      ...
      let minter;
      if(stakeTokenAddress.toLowerCase() === "0xb34e1a3D07f9D180Bc2FDb9Fd90B8994423e33c1".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x65f228ED6a6001eD6485535e0Dc33E525734f54c".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x067079c14B85169e6a29703769dadDef90816f4C".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x6ade6971Ca3d90990C30d39c78b0534C7166e07b".toLowerCase()){
      ...
      if(stakeTokenAddress.toLowerCase() === "0xb34e1a3D07f9D180Bc2FDb9Fd90B8994423e33c1".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x65f228ED6a6001eD6485535e0Dc33E525734f54c".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x067079c14B85169e6a29703769dadDef90816f4C".toLowerCase() || stakeTokenAddress.toLowerCase() === "0x6ade6971Ca3d90990C30d39c78b0534C7166e07b".toLowerCase()){
        ...
        const _stakeTokenPrice = await STAKING_TOKEN_MINTER.lp_price() / 1e18;
      ...
      if(stakeTokenPrice === undefined){
        stakeTokenPrice = poolPrices.price;
      }
  ...
  async function printPrismaPool(App, info, chain="eth", customURLs) {
