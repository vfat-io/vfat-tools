  ...
  async function main() {  
    ...
    const LAUNCHPOOL_CONTRACT0 = new ethers.Contract(LAUNCHPOOL_CHEF_ADDR0, LAUNCHPOOL_STAKING_ABI, App.provider);
    const LAUNCHPOOL_CONTRACT1 = new ethers.Contract(LAUNCHPOOL_CHEF_ADDR1, LAUNCHPOOL_STAKING_ABI, App.provider);
    const LAUNCHPOOL_CONTRACT2 = new ethers.Contract(LAUNCHPOOL_CHEF_ADDR2, LAUNCHPOOL_STAKING_ABI, App.provider);
    ...
    const rewardsPerWeek2 = await LAUNCHPOOL_CONTRACT2.rewardPerBlock() / 1e18 * 604800 / 13.5;

    await loadLaunchpoolChefContract(App, LAUNCHPOOL_CONTRACT0, LAUNCHPOOL_CHEF_ADDR0, LAUNCHPOOL_STAKING_ABI,
        launchpoolRewardTokenTicker, tokenRewardAddress, null, rewardsPerWeek0, "pendingRewards")

    await loadLaunchpoolChefContract(App, LAUNCHPOOL_CONTRACT1, LAUNCHPOOL_CHEF_ADDR1, LAUNCHPOOL_STAKING_ABI,
        launchpoolRewardTokenTicker, tokenRewardAddress, null, rewardsPerWeek1, "pendingRewards")
    
    await loadLaunchpoolChefContract(App, LAUNCHPOOL_CONTRACT2, LAUNCHPOOL_CHEF_ADDR2, LAUNCHPOOL_STAKING_ABI,
        launchpoolRewardTokenTicker, tokenRewardAddress, null, rewardsPerWeek2, "pendingRewards")
