...
const GOOSE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract EggToken', name: '_egg', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_eggPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'egg',
    outputs: [{internalType: 'contract EggToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accEggPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_eggPerBlock', type: 'uint256'}],
...
const GG1_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract IMintable', name: '_goose', type: 'address'},
      {internalType: 'address', name: '_devAddress', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_goosePerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_maxGooseSupply', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  {
    inputs: [
      {internalType: 'uint256[]', name: 'pidArray', type: 'uint256[]'},
      {internalType: 'address', name: '_user', type: 'address'},
    ],
    name: 'bulkHarvestFor',
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: 'goose',
    outputs: [{internalType: 'contract IMintable', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accGoosePerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'depositFeeBP', type: 'uint256'},
      {internalType: 'uint256', name: 'maxDepositAmount', type: 'uint256'},
      {internalType: 'uint256', name: 'currentDepositAmount', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_goosePerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
const STRAT_ABI = [
  ...
  {inputs: [], name: 'convertDustToEarned', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
...
const GOOSE_VAULTS_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_treasury', type: 'address'},
      {internalType: 'address', name: '_gooseDollar', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'uint256', name: 'pid', type: 'uint256'},
      {indexed: false, internalType: 'address', name: 'wantAddress', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'amountGained', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'valueGained', type: 'uint256'},
    ],
    name: 'Earn',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'address', name: 'newAddr', type: 'address'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'emissionRate', type: 'uint256'},
    ],
    name: 'UpdateVaultEmission',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [{internalType: 'bool', name: 'withUpdate', type: 'bool'}],
    name: 'updateVaultEmission',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const GOOSE_CHEF_ADDR = '0xe70E9185F5ea7Ba3C5d63705784D8563017f2E57'
  const GG1_CHEF_ADDR = '0x22cC57c9ec341152834F216289A1824d61b47855'
  const GOOSE_VAULTS_ADDR = '0x3F648151f5D591718327aA27d2EE25edF1b435D8'
  const rewardTokenTicker = 'EGG'
  const rewardTokenTickerGG1 = 'GG1'
  const rewardTokenTickerGUSD = 'GUSD'
  const GOOSE_CHEF = new ethers.Contract(GOOSE_CHEF_ADDR, GOOSE_CHEF_ABI, App.provider)
  const GG1_CHEF = new ethers.Contract(GG1_CHEF_ADDR, GG1_CHEF_ABI, App.provider)
  const GOOSE_VAULTS = new ethers.Contract(GOOSE_VAULTS_ADDR, GOOSE_VAULTS_ABI, App.provider)

  const rewardsPerWeek = (((await GOOSE_CHEF.eggPerBlock()) / 1e18) * 604800) / 3

  const rewardsPerWeekGG1 = (((await GG1_CHEF.goosePerBlock()) / 1e18) * 604800) / 3
  ...
  await loadGooseChefContract(
    ...
    GOOSE_VAULTS_ADDR,
    GOOSE_VAULTS_ABI,
    rewardTokenTickerGUSD,
    'originRewardsPerBlock',
    'pendingRewards'
  )
...
async function loadGooseChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x =>
        await getBscGoosePoolInfo(App, chefContract, x, pendingRewardsFunction, rewardsPerBlockFunction, chefAddress)
    )
  )
  ...
  for (i = 0; i < poolCount; i++) {
    if (poolPrices[i]) {
      printChefPool(
        ...
        poolPrices[i],
        totalAllocPoints,
        poolInfos[i].rewardsPerWeek,
        rewardTokenTicker,
        poolInfos[i].rewardTokenAddress,
        pendingRewardsFunction
      )
    }
  }
...
async function getBscGoosePoolInfo(
  app,
  chefContract,
  poolIndex,
  pendingRewardsFunction,
  ...
  const rewardTokenAddress = await chefContract.gooseDollar()
  const rewardToken = await getBscToken(app, rewardTokenAddress, chefAddress)
  const rewardsPerWeek =
    (((await chefContract.callStatic[rewardsPerBlockFunction](poolIndex)) / 10 ** rewardToken.decimals) * 604800) / 3
  if (poolInfo.allocPoint == 0 || poolInfo.accRewardsPerShare == 0) {
    return {
