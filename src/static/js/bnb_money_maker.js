$(function () { consoleInit(main) });
  async function main() {
    ...
    prettyTable("Project",
      [{ k:"", v:"Same concept has been launched on multiple chains", l:null },
       { k:"", v:"Get in early"                   , l:null         },
       { k:"", v:"Dont miss out!"     , l:null         },
       { k:"", v:"Contract ownership renounced"  , l:renounceLink },
       { k:"", v:"Go and make some money!."  , l:null         }

      ]);
    const plannames     = ["TORTOISE 🐢", "FLAMINGO 🦩", "OCTOPUS 🐙", "SCORPION 🦂", "EAGLE 🦅", "SHARK 🦈", "BULL 🐂", "ELEPHANT 🐘"];
    const telegramLink  = "Coming Soon!";
    ...
    const refLink       = "https://vfat.tools/bsc/bnb_money_maker/?ref=" + app.YOUR_ADDRESS.toString();
    _print("<hr>")
    ...
    //---------------------------------------------------------------------------
    function init() {
      document.title = "BNB MONEY MAKER. GET UP TO 8% ROI PER DAY. REFER AND GET 6% FEE";
    }
