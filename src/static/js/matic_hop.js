$(function() {
  ...
  const Addresses = [
    "0xAA7b3a4A084e6461D486E53a03CF45004F0963b7", //ETH
    "0x7811737716942967Ae6567B26a5051cC72af550E", //USDC
    "0xd6dC6F69f81537Fe9DEcc18152b7005B45Dc2eE7", //DAI
    "0x297E5079DF8173Ae1696899d3eACD708f0aF82Ce"  //USDT
  ]
  ...
  async function main() {
    ...
    const oldPools = OldAddresses.map(a => { return {
      address: a,
      abi: HOP_STAKING_ABI,
      stakeTokenFunction: "stakingToken",
      rewardTokenFunction: "rewardsToken"
    ...
    //old pools here
    _print_bold("Old Pools Here");
    let p2 = await loadMultipleMaticSynthetixPools(App, tokens, prices, oldPools)
