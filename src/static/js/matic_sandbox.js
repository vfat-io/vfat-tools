...
const Pool = {
  ...
  stakeTokenAddress: "0x369582d2010b6ed950b571f4101e3bb9b554876f",
  rewardTokenAddress: "0xBbba073C31bF03b8ACf7c28EF0738DeCF3695683"
}
...
async function loadSandboxPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  tokenAddress, stakingTokenAddress) {
    ...
    const calls = [STAKING_MULTI.periodFinish(), STAKING_MULTI.rewardRate(),
      ...
      STAKING_MULTI.multiplierOf(App.YOUR_ADDRESS)]
    const [periodFinish, rewardRate, balance, earned_, multiplier] = await App.ethcallProvider.all(calls);
    ...
    const earned = multiplier > 0 ? earned_ * multiplier / 10 ** rewardToken.decimals : earned_ / 10 ** rewardToken.decimals;
