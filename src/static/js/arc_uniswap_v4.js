...
const nft_manager_address_v4 = '0x6049c9a0e26405C0985f9E3685C87d0aE917f82B'
const pool_manager_address_v4 = '0x8366a39CC670B4001A1121B8F6A443A643e40951'
// Reading current tick/sqrtPrice is done via StateView, not PoolManager.
const state_view_address_v4 = '0xF3334192D15450CdD385c8B70e03f9A6bD9E673b'
const sickle_factory_address = '0x36F89Be8cEF366a97129c7d18cFCAf860BA9Ff7C'
const sweep_address = '0x4fD738409D33BB9061f16c3618D63B0296395a7c'
...
const withdraw_nfts = async function (App, nft_manager_v4, nft_manager_address_v4, sickleAddress, retry = 0) {
  ...
  if (active_nfts.length > 0) {
    ...
    for (const p of positions) {
      ...
      const token0Meta = await getErc20MetaCached(App, tokenMetaCache, p.poolKey.currency0, ARC_CHAIN_ID)
      const token1Meta = await getErc20MetaCached(App, tokenMetaCache, p.poolKey.currency1, ARC_CHAIN_ID)
...
const fallback_withdraw = async function (App, nft_manager_address_v4, sickleAddress) {
  ...
  _print(
    `<a target="_blank" href="https://explorer.arc.io/address/${sickleAddress}?tab=tokens_nfts">Nft Position Manager</a>`
  )
  _print('')
