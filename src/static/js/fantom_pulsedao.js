$(function () {		
  ...
  async function main() {		
      ...
      _print(`\nStaked pSHAREs can only be withdrawn after 6 epochs since deposit.\n`);
...
async function loadFantomPshareContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
