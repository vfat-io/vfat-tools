$(function () { consoleInit(main) });
  async function main() {
    ...
    ///------------------------------------------------------------------------
    _print("<hr>")
    _print(header(2, "BSC Defi Eco System"));
    const renounceLink = "https://bscscan.com/tx/0x999c85f0646ee527a06d39fc668e7ba64164baa7bc6b3e4d268e3d66de49fad9";
    prettyTable("Project",
      [{ k:"", v:"BSC Defi Eco System", l:null },
       { k:"", v:"Stake BNB. Earn BNB"                   , l:null         },
    ...
    //---------------------------------------------------------------------------
    function init() {
      document.title = "BSC DEFI ECO SYSTEM.";
    }
...
function getAddress() {
  return "0x054c683647Ea33C683407b7a8891C45A635408b7";
}
