$(function () { consoleInit(main) });
  async function main() {
    ...
    ///------------------------------------------------------------------------
    _print("<hr>")
    _print(header(2, "BINANCE SMART CHAIN DEFI ECO SYSTEM"));
    

    const bscdefiecoLink = "https://vfat.tools/bsc/bsc_defieco/";
    const renounceLink = "https://bscscan.com/tx/0xed6ff9b3238e63da58b72c7a9c50fb8501b1c0eb8e1248cdf1e29df004e65adf";
    prettyTable("DEFI ECO SYSTEM",
      [{ k:"", v:"PART #1 - BINANCE SMART CHAIN", l:bscdefiecoLink },
       { k:"", v:"Play it SAFE -OR- Play is RISKY"                   , l:null         },
       { k:"", v:"Contract ownership renounced"  , l:renounceLink },
       { k:"", v:"DYOR!"  , l:null         }

      ]);
    const planNames     = ["SAFE 7 DAYS", "SAFE 14 DAYS", "RISKY 7 DAYS", "RISKY 14 DAYS"];
    //const telegramLink  = "https://";
    //const twitterLink   = "https://";
    //const redditLink    = "https://";
    //const docsLink      = "https://";
    //prettyTable("Socials",
    ...
    const earlyFeeInfo  = prettyInt(earlyFee)  + "% (plans 3 and 4 only)";
    const refLink       = "https://vfat.tools/bsc/bsc_defieco/?ref=" + app.YOUR_ADDRESS.toString();
    _print("<hr>")
    ...
    //---------------------------------------------------------------------------
    function init() {
      document.title = "BSC ECO SYSTEM - Play it SAFE -OR- Play is RISKY";
    }
...
function getAddress() {
  return "0x186A694c7e42b6e0dE735E1196F4efdb1aA0a68f";
}
