...
async function getArbitrumYieldyakVault(App, vault, address, stakingAddress) {
...
async function getArbitrumYieldyakVault2(App, vault, address, stakingAddress) {
  const decimals = await vault.decimals()
...
async function getAvaxStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
    ...
    case "arbitrumYieldyakVault":
      const yieldyakVault = new ethcall.Contract(tokenAddress, YIELDYAK_VAULT_UNDERLYING_ABI);
      return await getArbitrumYieldyakVault(App, yieldyakVault, tokenAddress, stakingAddress);
    case "arbitrumYieldyakVault2":
      const yieldyakVault2 = new ethcall.Contract(tokenAddress, YIELDYAK_VAULT_UNDERLYING_ABI2);
      return await getArbitrumYieldyakVault2(App, yieldyakVault2, tokenAddress, stakingAddress);
    case "vault":
...
async function getAvaxToken(App, tokenAddress, stakingAddress) {
    ...
    try {
      ...
      const yieldyakVault2 = await getArbitrumYieldyakVault2(App, YIELDYAK_VAULT2, tokenAddress, stakingAddress);
      window.localStorage.setItem(tokenAddress, "arbitrumYieldyakVault2");
