...
const HUMP_ADDRESS = "0x453939C0270e9405876C7f047aDE3932FD2d7a51";
const DISTRIBUTOR_ADDRESS = "0xb001f88312BB908E014018CCaBfa93f05850c609";
const PRESALE_ADDRESS = '0x29F5cc2Ad5F061FcC06b437FA8F3d2F9c9BbC82e';
const BOND_ADDRESS = '0x1220A95DAb05318d5F4a6Ceb805B490c221D16Bd';
const sHUMP_ADDRESS = '0x16ed43AA2956eB2B79C9ed91793221b8719049c3';
const STAKING_ADDRESS = '0x411Ba19A7D908068A1Cb5BD808da008f5A977Cbc';
...
async function main() {
    ...
    const bondBalance = await HUMP_CONTRACT.balanceOf(BOND_ADDRESS);
    const presaleBalance = await HUMP_CONTRACT.balanceOf(PRESALE_ADDRESS);
    ...
    const humpCircSupply = (humpTotalSupply - distributorBalance - bondBalance - presaleBalance) / 10 ** humpDecimals;
