...
async function main() {
   ...
   const HONEY_CHEF_ADDR = "0xf85CD66461088284480a455D2B2933E69B789BAF";
   ...
   if(currentBlock < startBlock){
    ...
    await loadArbitrumChefContract(App, tokens, prices, HONEY_CHEF, HONEY_CHEF_ADDR, HONEY_CHEF_ABI, rewardTokenTicker,
        "honey", null, rewardsPerWeek, "pendingHoney");
