...
const NFT_FARM_STRATEGY_ADDRESS = "0x9D70B9E5ac2862C405D64A0193b4A4757Aab7F95";
const FARM_STRATEGY_ADDRESS = "0x32ddFf55910c80b188239fE670F8432094a64B72";
...
async function main() {
  ...
  const CAKE_V3_CHEF_ADDR = "0x5e09acf80c0296740ec5d6f643005a4ef8daa694";
  ...
  await loadPancakeV3Contract(App, prices, CAKE_V3_CHEF, CAKE_V3_CHEF_ADDR, CAKE_V3_CHEF_ABI, rewardTokenTicker, "0x1b896893dfc86bb67Cf57767298b9073D2c1bA2c", sickle_account_address, has_sickle_account, owner_sickle_address);
...
function printCakeV3ContractLinks(App, chefAbi, chefAddr, positionInfo, rewardTokenTicker, rewardTokenPrice, has_sickle_account, owner_sickle_address, prices) {
  ...
  if (has_sickle_account && window.Sickle?.withdraw) {
    // Get native token symbol dynamically (Arbitrum chain ID is 42161)
    const nativeSymbol = window.Sickle?.SickleUtils?.getNativeTokenSymbol?.(42161) || 'ETH'
...
function sickle_pancakeV3Contract_unstake(nft_id, App, token0Address, token1Address){
  ...
  const masterchef_address = "0x5e09acf80c0296740ec5d6f643005a4ef8daa694";
  const reward_token_address = "0x1b896893dfc86bb67Cf57767298b9073D2c1bA2c";
