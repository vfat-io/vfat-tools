...
$(function() {
    ...
    async function main() {
       ...
       const PANCAKE_CHEF_ADDR = "0x9F887f888028c3982445D2DdF3300cd2e9787beB";
       ...
       const rewardsPerWeek = await PANCAKE_CHEF.merdPerBlock() /1e18
        ...
        await loadAvaxChefContract(App, tokens, prices, PANCAKE_CHEF, PANCAKE_CHEF_ADDR, PANCAKE_CHEF_ABI, rewardTokenTicker,
