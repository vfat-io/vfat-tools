...
const contracts = {
  comptroller: '0xedba32185baf7fef9a26ca567bc4a6cbe426e499',
  oracle: '0x0b510A226F4A7A66c480988704eCd5306B6f1954',
  gas: {
      p_address: '0xEbd7f3349AbA8bB15b897e03D6c1a4Ba95B55e31',
      symbol: 'MATIC',
      decimals: 18,
  },
};
...
async function main() {
  ...
  /*const HND_GAUGES_CONTROLLER_ADDR = "0xa8cD5D59827514BCF343EC19F531ce1788Ea48f8";
  ...
  const gaugeAddresses = ["0x08110737CB8276B155aB18533dacF7d27e2357c8", "0x6333000289bc27A090b3D51E734C2f13e3edc4fd", "0x274E94f03AC51779D14bD45aF77C0e0e9d97cef9"]
  ...
  //HND reward token
  const rewradToken = await getMaticToken(App, "0x10010078a54396f62c96df8532dc2b4847d47ed3", App.YOUR_ADDRESS);
  ...
  for(let i = 0; i < gageInfos.length; i++){
    const lpToken = await getMaticToken(App, gageInfos[i].lpTokenAddress, gaugeAddresses[i]);
    ...
    const poolPrice = getPoolPrices(tokens, prices, lpToken, "matic")
