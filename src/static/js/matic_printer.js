...
async function main() {
    ...
    const INK_CHEF_ADDR = "0x4c25ffcbac4bb1a01fb25a73d5eca02b98753d08";
    ...
    await loadMaticPrinterChefContract(App, tokens, prices, INK_CHEF, INK_CHEF_ADDR, INK_CHEF_ABI, rewardTokenTicker,
        "ink", null, rewardsPerWeek, "pendingShare");

    hideLoading();
}

async function loadMaticPrinterChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
