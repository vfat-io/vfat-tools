...
async function main() {
   ...
   const SYN_CHEF_ADDR = "0xaed5b25be1c3163c907a471082640450f928ddfe";
   const rewardTokenTicker = "SYN";
   const SYN_CHEF = new ethers.Contract(SYN_CHEF_ADDR, SYN_CHEF_ABI, App.provider);

  const rewardPerBlock = await SYN_CHEF.synapsePerSecond();
  const rewardsPerWeek = rewardPerBlock / 1e18 * 604800;

    const tokens = {};
    const prices = await getHarmonyPrices();

    prices["0xE269abBFAF52b26D2632F55B6b223A5223088B96"] = { usd : 1 };
