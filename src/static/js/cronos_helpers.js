...
const CronosTokens = [
    { "id": "CryptoCom Coin","symbol": "CRO","contract": "0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23" },
    ...
    { "id": 'bitcoin', "symbol": 'WBTC', "contract": '0x062E66477Faf219F25D27dCED647BF57C3107d52' },
    { "id": 'wrapped-cronos', "symbol": 'WCRO', "contract": '0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23' },
    { "id": "crodex", "symbol": "CRX", "contract": "0xe243CCab9E66E6cF1215376980811ddf1eb7F689"},
    { "id": "crofarmer", "symbol": "CRF", "contract": "0x2f93f667308BFebEBaad78B36F8a25b65c8Ad721"}
];
...
async function getCronosStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
    ...
    case "cronosVault":
      const vault = new ethers.Contract(tokenAddress, CRONOS_VAULT_TOKEN_ABI, App.provider);
      return await getCronosVault(App, vault, tokenAddress, stakingAddress);
    case "cronosWantVault":
      const wantVault = new ethers.Contract(tokenAddress, CRONOS_VAULT_WANT_ABI, App.provider);
...
async function getCronosToken(App, tokenAddress, stakingAddress) {
    ...
    try {
      const WANT_VAULT = new ethers.Contract(tokenAddress, CRONOS_VAULT_WANT_ABI, App.provider);
