$(function () {		
    ...
    async function main() {		
        ...
        const StakingPool = {
          address : "0xbf7da01f806f9e01c62c887003b8c9761b169b76",
          abi : PIGGY_STAKING_ABI,
          stakeTokenFunction : "share",
          rewardTokenAddresses : "piggy"
        }
        
        const PSHARE_CHEF_ADDR = "0xD742992bc78852E1c5cfbC70eA3c72689Fa72304";
  ...
  async function loadFantomPIGGYSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
    const info = await loadFantomPIGGYSynthetixPoolInfo(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction);
    if (!info) return null;
    return await printPIGGYSynthetixPool(App, info, "fantom");
  }
  
  async function loadFantomPIGGYSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  ...
  async function printPIGGYSynthetixPool(App, info, chain="eth", customURLs) {
