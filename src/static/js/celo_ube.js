...
async function loadMultipleRewardsUbePoolInfo(App, tokens, prices, stakingAbi, stakingAddress, rewardsNumber) {
    ...
    const rewardRateA = await STAKING_POOL.rewardRate();
    const weeklyRewardA = rewardRateA / 10 ** rewardTokens[2].decimals * 604800;
    const usdPerWeekA = weeklyRewardA * rewardTokenPrices[2];
