...
const contracts = {
  comptroller: '0x6bb6ebCf3aC808E26545d59EA60F27A202cE8586',
  oracle: '0x36208A6D429b056BE6bE5fa81CdF4092748ac35D',
  gas: {
      //p_address: '0x090a00A2De0EA83DEf700B5e216f87a5D4F394FE',  //hXDAI old?
      p_address: '0x6eDCB931168C9F7C20144f201537c0243b19dCA4',  //hXDAI
      symbol: 'xDAI',
      decimals: 8,
  },
};
...
async function main() {
  ...
  const HND_GAUGES_CONTROLLER_ADDR = "0x2105dE165eD364919703186905B9BB5B8015F13c";
  const HND_GAUGES_CONTROLLER = new ethcall.Contract(HND_GAUGES_CONTROLLER_ADDR, HND_GAUGES_CONTROLLER_ABI);

  //const gaugeAddresses = ["0x7BFE7b45c8019DEDc66c695Ac70b8fc2c0421584", "0x0d124443c853F8999bA14531B49E34D6540654d1"];  //hxDAI and hUSDC
  const gaugeAddresses = ["0x5835d6A367Ded86dbc33CE796eD5013488D205c0", "0x5BA443267c09578bfd87e033a401F69d37Fe677e"];  //hxDAI and hUSDC
  ...
  //HND reward token
  const rewardToken = await getGeneralToken(App, "0x10010078a54396F62c96dF8532dc2B4847d47ED3", App.YOUR_ADDRESS);
  ...
  for(let i = 0; i < gageInfos.length; i++){
    const lpToken = await getGeneralToken(App, gageInfos[i].lpTokenAddress, gaugeAddresses[i]);
    ...
    prices["0x090a00A2De0EA83DEf700B5e216f87a5D4F394FE"] = { usd : 1 }; //added manually the price of hxDAI to 1 old lptoken
    prices["0x6eDCB931168C9F7C20144f201537c0243b19dCA4"] = { usd : 1 }; //added manually the price of hxDAI to 1
    const poolPrice = getPoolPrices(tokens, prices, lpToken, "xdai")
