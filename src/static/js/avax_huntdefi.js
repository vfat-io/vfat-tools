$(function() {
    ...
    async function main() {
        ...
        const HUNT_CHEF_ADDR = "0x8F510eA7c4ACEbcfae08c3660DdcDb1fF69B2f0A";
        ...
        if (currentBlock < startBlock) {
            ...
            rewardsPerWeek = await HUNT_CHEF.HuntPerBlock() /1e18 * 604800 / blocksPerSeconds;
        }

        const tokens = {};
        const prices = await getAvaxPrices();

        await loadHuntChefContract(App,
            tokens,
            prices,
            HUNT_CHEF,
            HUNT_CHEF_ADDR,
