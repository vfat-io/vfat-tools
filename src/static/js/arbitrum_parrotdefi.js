...
async function main() {
 ...
 const PPEGG_CHEF_ADDR = "0x1cCf20F4eE3EFD291267c07268BEcbFDFd192311";
 ...
 let rewardsPerWeek = await PPEGG_CHEF.EggPerBlock() /1e18
  ...
  await loadArbitrumParrotChefContract(App, tokens, prices, PPEGG_CHEF, PPEGG_CHEF_ADDR, PPEGG_CHEF_ABI, rewardTokenTicker,
      "egg", null, rewardsPerWeek, "pendingEgg");

  hideLoading();
}

async function loadArbitrumParrotChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
  ...
  const magicWethLP = await getArbitrumToken(App, "0x8eDfb54E8c76C512DBdD4FAa252Bf4E163CaAD32", chefAddress);
  getPoolPrices(tokens, prices, magicWethLP, "arbitrum")
