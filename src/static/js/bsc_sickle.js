...
const SLIPSTREAM_NFT_MANAGER_ADDRESS_3 = "0xa51ADb08Cbe6Ae398046A23bec013979816B77Ab";
    ...
    if(sickleAddress === "0x0000000000000000000000000000000000000000"){
      ...
      if(nfts_3 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Sweep THENA erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Sweep all THENA erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
    }
