...
async function loadSquirrelContracts(App) {
    ...
    printAPR("NUTS", nutsPrice, 8000, apeLpPrices.stakeTokenTicker, apeLpPrices.staked_tvl, userApeStaked, apeLpPrices.price);
    ...
    printAPR("NUTS", nutsPrice, 7000, busdLpPrices.stakeTokenTicker, busdLpPrices.staked_tvl, userBusdStaked, busdLpPrices.price);
