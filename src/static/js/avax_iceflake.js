$(function () {
    ...
    async function main() {
        ...
        const FLAKE_CHEF_ADDR = "0xd31161682b20477045627ddd84607e87350aef0a";
        const rewardTokenTicker = "FLAKE";
        const FLAKE_CHEF = new ethers.Contract(FLAKE_CHEF_ADDR, FLAKE_CHEF_ABI, App.provider);

        const blocksPerSeconds = 1;

        const startBlock = Number(await FLAKE_CHEF.startTimestamp());
        ...
        if(currentBlock < startBlock){
            ...
            rewardsPerWeek = await FLAKE_CHEF.tokenPerSecond() / 1e18 *
