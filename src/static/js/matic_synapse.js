$(function () {		
    ...
    async function main() {		
        ...
        const SYN_CHEF_ADDR = "0x7875Af1a6878bdA1C129a4e2356A3fD040418Be5";
        ...
        prices["0x7479e1Bc2F2473f9e78c89B4210eb6d55d33b645"] = { usd : 1};
...
async function loadSynChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
  ...
  const poolInfos = await Promise.all([...Array(poolCount).keys()].map(async (x) =>
    await getSynapsePoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)));
