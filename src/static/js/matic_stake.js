$(function () { consoleInit(main) });
  async function main() {
    ...
    ///------------------------------------------------------------------------
    _print("<hr>")
    const title = "</br><h2 style='font-size:40px'>🏦 MATIC STAKE 🏦</h2>"
    const easy123 = "<h2 style='font-size:30px'>SIR IT'S AS EASY AS 1, 2, 3!</h2>"
    _print(title)
    _print(easy123)
    const stake = "<h3 style='font-size:25px'>1. STAKE IT 💰</h2><p style='font-size:16px;text-align:left'>STAKE MATIC IN ONE OF THE 8 PLANS</p>"
    _print(stake)
    const shill = "<h3 style='font-size:25px'>2. SHILL IT 👨‍👨‍👧‍👧</h2><p style='font-size:16px;text-align:left'>SEND THE SHILL MESSAGE TO EVERYONE YOU KNOW AND GET 6% PROFIT ON THEIR STAKES</p>"
    const shill2 = "<div style='font-size:16px;text-align:left;border-style:solid;padding:5px 5px 5px 5px'>🏦 MATIC STAKE 🏦</br>THE FIRST SAFE MATIC STAKING CONTRACT ON VFAT PAGE</br></br>CONTRACT: 0x790F87712E2BE0231e2c556Ae4e5970573e577ED</br>WEBSITE: https://vfat.tools/polygon/matic_stake/?ref=&lt;YOUR WALLET ADDRESS&gt;</br>TELEGRAM: https://t.me/matic_stake</br></br>MINIMUM STAKE = 10 MATIC</br></br>8 STAKING PLANS</br><ul style='font-size:16px'><li>Plan 1. TORTOISE 🐢. from 8% per day, for 14 days. Total return of 112%, withdrawal at any time</li><li>Plan 2. FLAMINGO 🦩. from 6.5% per day, for 21 days. Total return of 136%, withdrawal at any time</li><li>Plan 3. OCTOPUS 🐙. from 5.5% per day, for 28 days. Total return of 154%, withdrawal at any time</li><li>Plan 4. SCORPION 🦂. from 4.5% per day, for 35 days. Total return of 157%, withdrawal at any time</li><li>Plan 5. EAGLE 🦅. from 8% per day, for 14 days. Total return of 193%, withdrawal at the end of the plan</li><li>Plan 6. SHARK 🦈. from 6.5% per day, for 21 days. Total return of 275%, withdrawal at the end of the plan</li><li>Plan 7. BULL 🐂. from 5.5% per day, for 28 days. Total return of 347%, withdrawal at the end of the plan</li><li>Plan 8. ELEPHANT 🐘. from 4.5% per day, for 35 days. Total return of 366%, withdrawal at the end of the plan</li></ul><p style='font-size:16px;text-align:left'>EVERY DAY STAKE PERCENTAGES INCREASE BY 0.3% FOR NEW STAKES</p></br>REFERAL SCHEME ✉️</br> 6% PROFIT ON REFERAL STAKES</br></br>CONTRACT OWNERSHIP RENOUNCED 🔐✅</br></br>STAKE IT 💰 SHILL IT 👨‍👨‍👧‍👧 MAKE IT 📈</div>"
    _print(shill)
    _print(shill2)
    const make = "<h3 style='font-size:25px'>3. MAKE IT 📈</h2><p style='font-size:16px;text-align:left'>MAKE PROFIT BY CLAIMING YOUR STAKING REWARDS</p>"
    _print(make)
    ...
    _print("<hr>")
    const plans = "<h1 style='font-size:40px'>STAKING PLANS</h3>"
    _print(plans)
    prettyPlanInfos(userInvestments, planInfos);
    hideLoading();
    //---------------------------------------------------------------------------
    function init() {
      document.title = "MATIC STAKE. STAKE IT. SHILL IT. MAKE IT.";
    }
...
function getAddress() {
  return "0x790F87712E2BE0231e2c556Ae4e5970573e577ED";
}
