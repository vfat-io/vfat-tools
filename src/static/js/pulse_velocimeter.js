...
async function main() {
  ...
  const FLOW_VOTER_ADDR = "0x8C4FF4004c8a85054639B86E9F8c26e9DA7ff738"
  const FLOW_VOTER_CONTRACT = new ethers.Contract(FLOW_VOTER_ADDR, FLOW_VOTER_ABI, App.provider);
  const FLOW_TOKEN_ADDR = "0x39b9D781dAD0810D07E24426c876217218Ad353D"
  ...
  await loadFlowSynthetixPoolInfoPrice(App, tokens, prices, "0xf5eDDb4781e3ec355F49Db60248b34B4D7c467e6", "0xf5eDDb4781e3ec355F49Db60248b34B4D7c467e6");
...
async function loadFlowSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  stakeTokenFunction) {
    ...
    const rewardTokenAddress = "0x39b9d781dad0810d07e24426c876217218ad353d";
