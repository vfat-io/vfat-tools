...
async function loadTitaniumSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  rewardTokenFunction, stakeTokenFunction) {
    ...
    const originalStakeTokenContract = new ethcall.Contract("0xA77d09743F77052950C4eb4e6547E9665299BecD", STAKE_TOKEN_ABI);
    const [stakedTokens] = await App.ethcallProvider.all([originalStakeTokenContract.balanceOf(stakingAddress)]);
