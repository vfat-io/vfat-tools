...
const GENESIS_TOMB_REWARD_POOL_ADDR = "0xDa0cB4684b02D8bB253Af60a942625D1BC9Ba53d";
const TSHARE_REWARD_POOL_ADDR = "0x3E6a10C75d33D4fF95A33342d33A73176Bcd0629";
const TOMB_ADDR = "0xDa5DB6C2a2FD53A2D3Fc4246bbD8ACCe5F93Bae1";
...
async function main() {
  ...
  const MASONRY_ADDR = "0x4E2950365024D27956538AB27C97083634DDBE90";
  const ORACLE_ADDR = "0x6b4591972E3E72bEfa75C7270ca4d64eEeDA189D";
  const rewardTokenAddress = "0xDa5DB6C2a2FD53A2D3Fc4246bbD8ACCe5F93Bae1"; //TOMB
  const lptAddress = "0x5db45a30732cf98fda72b9b91a0c554dc1f2e83b"; //TSHARE-FTM-LP
  const stakeTicker = "SZOMBI";
  const rewardTicker = "ZOMBI";
  ...
  let zombiRewardPool = await loadRewardPoolContract(App, tokens, prices, zombiRewardPoolGenerisContract, GENESIS_TOMB_REWARD_POOL_ADDR, ZOMBI_REWARD_GENERIS_POOL_ABI, "ZOMBI",
  ...
  let tShareRewardPool = await loadRewardPoolContract(App, tokens, prices, tShareRewardPoolContract, TSHARE_REWARD_POOL_ADDR, TSHARE_REWARD_POOL_ABI, "SZOMBI",
  ...
  // _print("")
  // let tombRewardPool = await loadRewardPoolContract(App, tokens, prices, tombRewardPoolContract, TOMB_REWARD_POOL_ADDR, TOMB_REWARD_POOL_ABI, "ZOMBI",
