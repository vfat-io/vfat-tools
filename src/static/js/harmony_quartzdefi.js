...
async function main() {
	...
	const rewardTokenTicker = "QSHARE";
	...
	const BOARDROOM_ADDR = "0xE1E48d3476027af9dC92542b3a60F2D45A36e082";
	const ORACLE_ADDR = "0x543AB16f3EDe6dDD26a7C182869a282618B0891C";
	const rewardTokenAddress = "0xb9E05B4C168B56F73940980aE6EF366354357009"; //TOMB
	const lptAddress = "0x157e2e205b8d307501f1aad1c5c96c562e6f07c5"; //TSHARE-FTM-LP
	const stakeTicker = "QSHARE";
	const rewardTicker = "QUARTZ";
	...
	// TREASURY
	const treasuryContract = new ethers.Contract("0xFc0B7c105A6dd49Fd956b607CA8c8f00Ed159353", QUARTZ_DEFI_TREASURY_ABI, App.provider.getSigner())
...
async function loadMasonry(App, prices, boardroomAddress, oracleAddress, lptAddress, rewardTokenAddress, stakeTicker, rewardTicker,
	...
	console.log(prices, rewardTokenAddress, rewardPrice);
