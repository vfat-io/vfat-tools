...
async function main() {
   ...
   const MOONSWAP_CHEF_ADDR = "0xCbc3E636314b442005a7196e0042B674e199b27c";
   const rewardTokenTicker = "MOON";
   const MOONSWAP_CHEF = new ethers.Contract(MOONSWAP_CHEF_ADDR, MOONSWAP_CHEF_ABI, App.provider);

   const blocksPerSeconds = await getAverageBlockTime(App);
   const startBlock = await MOONSWAP_CHEF.startTime();
    ...
    await loadGeneralChefContract(App, tokens, prices, MOONSWAP_CHEF, MOONSWAP_CHEF_ADDR, MOONSWAP_CHEF_ABI, rewardTokenTicker,
        "moon", null, rewardsPerWeek, "pendingMOON", [], "moonriver");
