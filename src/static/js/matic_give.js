...
const GIVE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract GiveToken', name: '_give', type: 'address'},
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'contract IReferral', name: 'newAddress', type: 'address'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'givePerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [],
    name: 'give',
    outputs: [{internalType: 'contract GiveToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accGivePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'contract IReferral', name: '_referral', type: 'address'}],
    name: 'setReferralAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'uint256', name: '_givePerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const GIVE_CHEF_ADDR = '0x56823FBB2Bfc1795AbA546F336ddf1c90cad38B3'
  const rewardTokenTicker = 'GIVE'
  const GIVE_CHEF = new ethers.Contract(GIVE_CHEF_ADDR, GIVE_CHEF_ABI, App.provider)

  const startBlock = await GIVE_CHEF.startBlock()
  ...
  if (currentBlock < startBlock) {
    ...
    rewardsPerWeek = (((await GIVE_CHEF.givePerBlock()) / 1e18) * 604800) / 2.1
  }
