...
const WOW_CHAIN_PARAMETERS = {
    ...
    PAIR_FACTORY_ADDRESS: "0xb58D4c6E7481DABeB47c96B57bf06Df9C26698a0",
    RESERVE_FACTORY_ADDRESS: "0x334ebaD4d6EC7Cf028022Ef8d923f674007BcEa7",
    PARAM_PROVIDER_FACTORY_ADDRESS: "0x1a63900164dc67492473e1fd506c840da55fcc2d",
...
const WOWswap = {
    ...
    async getReserve(App, reserveFactory, paramProviderFactory, tokenAddress, price) {
        ...
        try {
            ...
            console.log({
                token,
                debtRate: reserveDebt.averageRate.toString(),
                deposited,
                borrowed,
                utilization,
                borrowAPY,
