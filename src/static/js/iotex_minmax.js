...
async function printMcnSynthetixPool(App, tokens, prices, info, chain="iotex") {
    ...
    _print(`<a target="_blank" href="https://iotexscout.io/address/${info.stakingAddress}#code">Iotex Scout</a>`);
