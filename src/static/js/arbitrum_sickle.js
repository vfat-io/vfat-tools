    ...
    if(sickleAddress === "0x0000000000000000000000000000000000000000"){
      ...
      if(nfts_1 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Sweep PANCAKE erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Sweep all PANCAKE erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
      ...
      if(nfts_2 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Sweep RAMSES erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Sweep all RAMSES erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
