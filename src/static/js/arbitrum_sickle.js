...
const SWEEP_ADDR = "0xde181C7412162eeF86174D9F0dCB299B4C2284f4";
    ...
    if(sickleAddress === "0x0000000000000000000000000000000000000000"){
      ...
      if(nfts_5 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Withdraw CAMELOT erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Withdraw all CAMELOT erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
    }
