...
async function main() {
 ...
 const PPEGG_CHEF_ADDR = "0x83E7e97C4e92D56c0653f92d9b0c0B70288119b8";
 const rewardTokenTicker = "iPEGG";
 ...
 let rewardsPerWeek = await PPEGG_CHEF.EggPerBlock() /1e18
  ...
  await loadIotexParrotChefContract(App, tokens, prices, PPEGG_CHEF, PPEGG_CHEF_ADDR, PPEGG_CHEF_ABI, rewardTokenTicker,
      "egg", null, rewardsPerWeek, "pendingEgg");

  hideLoading();
}

async function loadIotexParrotChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
