...
async function main() {
    ...
    const ZOOKEEPER_ADDR = "0x8d04cCd71B1f16cB7A8eC22871aaCfd6F346B4C9";
    ...
    const rewardsPerWeek = await ZOOKEEPER.bambooPerBlock() / 1e18 * 604800 / 2;
...
async function getBambooPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction, showAll=false) {
    ...
    if (poolInfo.stakedHoldableToken != null &&
      ...
      stakedToken = await getMaticToken(app, poolInfo.stakedHoldableToken, chefAddress);
...
async function printZookeeperContractPoolsTable(title, App, chef, chefAddress, chefAbi, rewardTokenTicker,
    ...
    const rewardsPerWeek = rewardsPerWeekFixed ??
        ...
        / 10 ** rewardToken.decimals * 604800 / 2
