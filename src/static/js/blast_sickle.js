...
const SWEEP_ADDR = "0x8312beE9abb5A83F2Ff0146C3fE163e5E70cdA0c";
const SLIPSTREAM_NFT_MANAGER_ADDRESS_1 = "0x8881b3Fb762d1D50e6172f621F107E24299AA1Cd";
const SLIPSTREAM_NFT_MANAGER_ADDRESS_2 = "0xB218e4f7cF0533d4696fDfC419A0023D33345F28";
...
async function main() {
    ...
    if(sickleAddress === "0x0000000000000000000000000000000000000000"){
      ...
      const SLIPSTREAM_NFT_MANAGER_1 = new ethcall.Contract(SLIPSTREAM_NFT_MANAGER_ADDRESS_1, SLIPSTREAM_NFT_MANAGER_ABI);  // FENIX
      const SLIPSTREAM_NFT_MANAGER_2 = new ethcall.Contract(SLIPSTREAM_NFT_MANAGER_ADDRESS_2, SLIPSTREAM_NFT_MANAGER_ABI);  // UNI
      ...
      if(nfts_1 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Withdraw FENIX erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Withdraw all FENIX erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
      ...
      if(nfts_2 / 1 > 0){
        ...
        for(let i = 0; i < nft_ids.length; i++){
          ...
          _print_link(`Withdraw UNI erc721 token: ${nft_ids[i]}`, singleSweepErc721);

        }

        _print_link(`Withdraw all UNI erc721 tokens: ${token_ids}`, sweepErc721);
        _print("");
      }
    }
