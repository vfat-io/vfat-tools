...
async function main() {
    ...
    const pools = stabilizeAddresses.map(a => { return {
        address             : a,
        abi                 : STABILIZE_STAKING_ABI,
