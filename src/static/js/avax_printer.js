...
async function main() {
   ...
   const rewardsPerWeek = await INK_CHEF.inkPerSecond() /1e18 * 604800;
    ...
    await loadAvaxPrinterChefContract(App, tokens, prices, INK_CHEF, INK_CHEF_ADDR, INK_CHEF_ABI, rewardTokenTicker,
        "ink", null, rewardsPerWeek, "pendingShare");

    hideLoading();
  }

async function loadAvaxPrinterChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
