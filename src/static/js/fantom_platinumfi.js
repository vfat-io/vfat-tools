$(function () {		
    ...
    async function main() {		
        ...
        await loadFantomPlatinumContract(App, tokens, prices, SPLAT_CHEF, SPLAT_CHEF_ADDR, SPLAT_CHEF_ABI, rewardTokenTicker,		
            "splat", null, rewardsPerWeek, "pendingShare", [1]);		
    		
        hideLoading();		
    }		
    	
async function loadFantomPlatinumContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
