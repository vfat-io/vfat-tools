...
async function main() {
  ...
  const FLOW_VOTER_ADDR = "0xab9b68c9e53c94d7c0949fb909e80e4a29f9134a"
  const FLOW_VOTER_CONTRACT = new ethers.Contract(FLOW_VOTER_ADDR, FLOW_VOTER_ABI, App.provider);
  const FLOW_TOKEN_ADDR = "0xd386a121991E51Eab5e3433Bf5B1cF4C8884b47a"
...
async function loadFlowSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  stakeTokenFunction) {
    ...
    const rewardTokenAddress = "0xd386a121991E51Eab5e3433Bf5B1cF4C8884b47a";
