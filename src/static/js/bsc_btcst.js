...
const BTCST_CHEF_ABI = [{
    "inputs": [{
        "internalType": "contract BTCSTToken",
        "name": "_btcst",
        "type": "address"
        ...
        "name": "_feeAddress",
        "type": "address"
    }, {"internalType": "uint256", "name": "_btcstPerBlock", "type": "uint256"}, {
    ...
    "inputs": [],
    "name": "btcst",
    "outputs": [{"internalType": "contract BTCSTToken", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [],
    ...
    "inputs": [{"internalType": "uint256", "name": "_btcstPerBlock", "type": "uint256"}],
...
async function main() {
    ...
    // const rewardsPerWeek = await BTCST_CHEF.btcstPerBlock() /1e18
    //     * 604800 / 3;
     const rewardsPerWeek = await 806400;
    const tokens = {};
