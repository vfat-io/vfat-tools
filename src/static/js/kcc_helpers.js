...
async function getKccUniPool(App, pool, poolAddress, stakingAddress) {
    let q0, q1;
...
async function getKccStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
    case "uniswap":
...
async function getKccToken(App, tokenAddress, stakingAddress) {
...
async function loadKccSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
...
async function loadKccBasisFork(data) {
...
async function loadKccChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
...
async function loadMultipleKccSynthetixPoolsSequential(App, tokens, prices, pools) {
  let totalStaked  = 0, totalUserStaked = 0, individualAPRs = [];
