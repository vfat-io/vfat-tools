...
async function main() {
  ...
  const COSMIC_CHEF_ADDR = "0x12dc61f46718dd00e993da7865da15e8cb713094";
  ...
  const multiplier = await COSMIC_CHEF.getMultiplier(blockNumber, blockNumber+1);
  const rewardPerBlock = await COSMIC_CHEF.REWARD_PER_BLOCK();
