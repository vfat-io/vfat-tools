...
const getSiloMarketsData = async function () {
   const url = "https://gateway.thegraph.com/api/fbf06f34dad21c4df6a9e1f647ba1d16/deployments/id/QmRMtCkaYsizfmoavcE1ULwc2DkG1GZjXDHTwHjXAAH9sp"
...
async function main() {
   ...
   let rewardsTotal = Number(Number(rewardsTokenEmissionsUSD[0]).toFixed(2)) + Number(Number(rewardsTokenEmissionsUSD[1]).toFixed(2))
