...
$(function() {
  ...
  async function main() {
     ...
     const CHAD_CHEF_ADDR = "0x0e9160374a49fe5ef8117edd3053d38028354702";
  ...
  async function getChadPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
    ...
    const poolToken = await getHarmonyToken(app, poolInfo.lpToken ?? poolInfo.token ?? poolInfo.stakingToken, chefAddress);
