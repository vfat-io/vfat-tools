...
const main = async () => {
  let tableData = {
    ...
    rows: [
      ...
      [
        'Sapphire Recycle   ',
        `<a href="recycle "     >Various</a>`,
        'RECYCLE      ',
        'https://recycle.sapphiredefi.com',
      ],
      ...
      [
        'BlackGoat          ',
        `<a href='blackgoat'    >Various</a>`,
        'GOAT         ',
        'https://app.fanblackgoat.finance',
      ],
	  ...
	  ['WeBribe            ', `<a href='webribe'      >Various</a>`, 'WEBRIBE      ', 'https://webribe.me'],
