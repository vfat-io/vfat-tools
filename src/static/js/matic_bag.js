...
consoleInit(main)
  ...
  async function main() {
    ...
    const GOLD_CHEF_ADDR = "0x83d0Dc6C1E9f194046D1c0d603D342E215B47246";
...
async function getBagPoolInfo(App, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
  ...
  const rewardTokenAddress = "0x99032f154ec3b28dfe57875c7a098e1d004283fc";
...
function getBagPrices(prices, pool) {
  ...
  let poolUrl =`https://polygonscan.com/address/${pool.address}`;
