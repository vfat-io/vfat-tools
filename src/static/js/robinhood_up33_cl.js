...
const NFT_POSITION_MANAGER_ADDRESS = '0x07F44c47743A2f36414A82b9F558ECFCf0EEdCEf'
const NFT_FARM_STRATEGY_ADDRESS = '0xb3f294A240A781FfB6731C4D03AF5D23FbD20735'
...
async function main() {
  ...
  const VELO_VOTER_ADDRESS = '0x7F749fDD351C1Ceed82d76d7699CB631Eb8332a7'
  ...
  const VELO_FACTORY_ADDRESS_V3 = '0x1ac9dB4a2608ba45D6127B1737949b51Bb54B7F3'
  const VELO_FACTORY_V3 = new ethcall.Contract(VELO_FACTORY_ADDRESS_V3, VELO_V3_FACTORY_ABI)

  const is_v3_pool_calls = pools.map(p => VELO_FACTORY_V3.isPool(p))
...
async function loadVelodroneSynthetixPools(
  ...
  for (const i of infos) {
    await printVelodromePool(App, i, 'robinhood', customURLs)
  }
}
...
async function loadVelodromeSynthetixPoolInfo(
  ...
  for (const userNft of userStakedNfts) {
    ...
    const [_earned, decimals0, decimals1] = await App.ethcallProvider.all([
