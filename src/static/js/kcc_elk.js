...
$(function() {
  ...
  async function main() {
    ...
    await loadGeneralSynthetixPoolInfo(App, tokens, prices, pools[1].abi, pools[1].address,
      pools[1].rewardTokenFunction, pools[1].stakeTokenFunction, "kcc")
  
    let p = await loadMultipleGeneralSynthetixPools(App, tokens, prices, pools, "kcc")
  ...
  const ELKStakingContracts = [
    "0xC9C64aA3a0DCd2272100A0e81226d0272EE435e7",
    "0xB1f74a995EeBF242f84366BFF50D1684bF308065"
  ]