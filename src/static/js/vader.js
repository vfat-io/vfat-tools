...
consoleInit(main)
  ...
  async function main() {
    ...
    //na valw to address tou vader kapws

    let p = await loadSynthetixVaderPool(App, tokens, prices, Pool.abi, Pool.address, Pool.rewardTokenFunction, Pool.stakeTokenFunction);
...
async function loadSynthetixVaderPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
  const info = await loadSynthetixVaderPoolInfo(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction);
  return await printSynthetixPool(App, info);
}

async function loadSynthetixVaderPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
