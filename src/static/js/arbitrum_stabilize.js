...
consoleInit(main)
  ...
  async function main() {
    ...
    const OPERATOR_ADDR = "0xCE820d0E671d30f4ac0a5007346c0E85fE12039F";
    ...
    //await loadStbzSynthetixPoolInfoPrice(App, tokens, prices, "0x835a1BcA3e5da0752dD73BD3f89AC0357fD34943", "0x835a1BcA3e5da0752dD73BD3f89AC0357fD34943");

    const rewardTokenTicker = "STBZ";
    const rewardTokenAddress = "0x2C110867CA90e43D372C1C2E92990B00EA32818b";
...
async function loadStbzSynthetixPoolInfoPrice(App, tokens, prices, stakingAddress, stakeTokenAddress) {
