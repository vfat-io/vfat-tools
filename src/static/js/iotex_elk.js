...
async function main() {
  ...
  await loadGeneralEthcallSynthetixPoolInfo(App, tokens, prices, pools[0].abi, pools[0].address,
    pools[0].rewardTokenFunction, pools[0].stakeTokenFunction, "iotex")

  let p = await loadMultipleGeneralEthcallSynthetixPools(App, tokens, prices, pools, "iotex")
...
const ELKStakingContracts = [
  "0x4D5239131310E34F7b8690B8ad542E843AA932cB",
  "0x3B6076a8960DED24CF469C1D4a431B5c8A85ca9E",
  "0x987F0F465688D987e1Ad1e12B63F9b5f4027d35B",
  "0x8FffcCbfb8f69929C245Bb5d85BcCA1c645e2147"
]