...
async function main() {
  ...
  _print('Loading supernova gauges...\n')

  const BLACKHOLE_GAUGE_MANAGER_ADDRESS = '0x19a410046Afc4203AEcE5fbFc7A6Ac1a4F517AE2'
  ...
  const pools_response = await $.ajax({ url: 'https://api.vfat.io/v4/farms?chainId=1', type: 'GET' })
  ...
  const tokens_response = await $.ajax({
    url: 'https://api.vfat.io/v4/chain-tokens?chainId=1&pageSize=999',
    type: 'GET',
  })
