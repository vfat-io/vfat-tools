...
async function main() {
  ...
  const CAKE_V3_CHEF_ADDR = "0xC6A2Db661D5a5690172d8eB0a7DEA2d3008665A3";
  ...
  await loadPancakeV3Contract(App, prices, CAKE_V3_CHEF, CAKE_V3_CHEF_ADDR, CAKE_V3_CHEF_ABI, rewardTokenTicker, "0x3055913c90Fcc1A6CE9a358911721eEb942013A1", sickle_account_address, has_sickle_account, owner_sickle_address);
...
function sickle_pancakeV3Contract_unstake(nft_id, App, token0Address, token1Address){
  ...
  const masterchef_address = "0xC6A2Db661D5a5690172d8eB0a7DEA2d3008665A3";
  const reward_token_address = "0x3055913c90Fcc1A6CE9a358911721eEb942013A1";
