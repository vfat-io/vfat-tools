$(function () {
    ...
    async function main() {
        ...
        const startBlock = Number(await ICUBE_CHEF.startTimestamp());
        ...
        if(currentBlock < startBlock){
            ...
            rewardsPerWeek = await ICUBE_CHEF.tokenPerSecond() / 1e18 *
        ...
        await loadGeneralEthcallChefContract(App, tokens, prices, ICUBE_CHEF, ICUBE_CHEF_ADDR, ICUBE_CHEF_ABI, rewardTokenTicker,
