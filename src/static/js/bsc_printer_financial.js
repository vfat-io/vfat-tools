...
async function main() {
   ...
   const INK_CHEF_ADDR = "0xf4b0fd23af6fc66886ea59a5007500a27eaec0bb";
   ...
   const rewardsPerWeek = await INK_CHEF.inkPerSecond() /1e18 * 604800;
    ...
    await loadBscPrinterChefContract(App, tokens, prices, INK_CHEF, INK_CHEF_ADDR, INK_CHEF_ABI, rewardTokenTicker,
        "ink", null, rewardsPerWeek, "pendingShare");

    hideLoading();
  }

async function loadBscPrinterChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
