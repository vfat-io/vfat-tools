...
consoleInit(main)
  ...
  async function main() {
    ...
    const ACRV_CHEF_ADDR2 = "0x3cf54f3a1969be9916dad548f3c084331c4450b5";
    ...
    const ACRV_CHEF2 = new ethers.Contract(ACRV_CHEF_ADDR2, ACRV_CHEF_ABI, App.provider);

    _print("Please use the official site in order to withdraw or claim your rewards\n");

    await loadAlladinContract(App, ACRV_CHEF2, ACRV_CHEF_ADDR2, ACRV_CHEF_ABI, "pendingReward");
    _print("");
    _print_bold("*** Old vaults below, please migrate ***\n")
