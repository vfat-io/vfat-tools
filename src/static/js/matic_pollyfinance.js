...
consoleInit(main)
 ...
 async function loadPollyChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
   ...
   const poolInfos = await Promise.all([...Array(poolCount).keys()].map(async (x) =>
     await getPollyPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)));
