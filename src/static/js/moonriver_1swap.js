...
const MINI_CHEF_ABI = [
  {
    ...
    inputs: [{type: 'address', name: '_reward', internalType: 'contract IERC20'}],
  },
  {
    type: 'event',
    name: 'Deposit',
  ...
  },
  {
    ...
    inputs: [{type: 'uint256', name: '_rewardPerSecond', internalType: 'uint256'}],
  },
  {
    type: 'function',
    stateMutability: 'view',
    ...
    outputs: [
      {
        type: 'tuple',
        name: 'pool',
        internalType: 'struct OneSwapChef.PoolInfo',
        components: [
          {type: 'uint256', name: 'accRewardPerShare', internalType: 'uint256'},
          {type: 'uint256', name: 'lastRewardTime', internalType: 'uint256'},
          {type: 'uint256', name: 'allocPoint', internalType: 'uint256'},
